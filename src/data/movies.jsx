        ...
        return (
          <div key={index} className="contentBlock">
            ...
            <div className="detail">
              ...
              <div className={item.runtime}>Year: {item.runtime}</div>
              <div className="genres">
                <div className="titleGenres">Genres:</div>
                {item.genres.map((item, index) => {
                  return (
                    <div key={index} className="subGenres">
                      {item}
                    </div>
                  );
                })}
              </div>
              <div className={item.imdbRating}>
                IMDB Rating: {item.imdbRating}
              </div>
              <div className={item.imdbVotes}>IMDB Votes: {item.imdbVotes}</div>
            </div>
          </div>
        );
      })}
